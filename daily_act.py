...
def build_native_xml(doc_kind: str,
    ...
    if doc_kind == "writeoff":
        ...
        # ВАЖНО: Текст должен ТОЧНО совпадать с текстом из справочника СБИС!
        # Варианты: "производственные расходы", "общехозяйственные расходы", "коммерческие расходы"
        ET.SubElement(tabl_sklad, "СтрТабл", {
            "Назначение": "производственные расходы",
